...
The tool supports a fixed-order **simple** mode and a speaker-selected **dynamic** mode. It can route personas, the moderator, live-summary compression, and urgency voting to model providers of your choice.

[View the project on GitHub](https://github.com/guoran-future-hu/persona-roundtable)
